...
Nipple.prototype.computeDirection = function (obj) {
    ...
    //Attuo modifica per aggiungere le diagonali
    ...
    //Usati sono : pi/6 , pi/3 , pi*2/3 , pi*5/6
    if (rAngle > angle60 && rAngle <= (angle60 * 2)) {
        direction = 'up';
    } else if (rAngle > (angle60)/2 && rAngle <= angle60) {
        direction = 'leftUp';
    } else if (rAngle > -(angle60)/2 && rAngle <= (angle60)/2) {
        direction = 'left';
    } else if(rAngle > -(angle60) && rAngle <= -(angle60)/2){
        direction = 'leftDown';
    } else if(rAngle > -(angle60 * 2) && rAngle <= -(angle60)){
        direction = 'down';
    } else if(rAngle > -(angle60 * 5)/2 && rAngle <= -(angle60 *2)){
        direction = 'rightDown';
    } else if(rAngle > (angle60 *2) && rAngle <= (angle60 * 5)/2){
        direction = 'rightUp';
    }else {
        direction = 'right';
    }
